...
const CartPage = async () => {
  ...
  return (
    <div className="px-4 media-960:flex-row flex flex-col gap-10 max-w-[1280px] m-auto min-h-[80vh]">
      {/* list of items */}
      ...
      {cartItems.data.length > 0 && (
        <div className="mt-10 flex-col flex media-960:flex-col-reverse media-960:justify-end media-960:w-[37.5%] gap-10">
          ...
          <div>
            <Link href="/checkout" className="flex flex-1 mt-10" aria-label="link to checkout page">
              <ButtonWithShadow
                title="checkout"
                sideIcon={RightArrowIcon}
                iconHeight={40}
